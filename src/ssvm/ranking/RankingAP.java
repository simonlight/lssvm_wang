...
public class RankingAP {
	...
	public RankingAP(int dim, int nbPlus, int nbMinus, List<Integer> gtRanking) {
		super();
		this.dim = dim;
		this.nbPlus = nbPlus;
		...
		System.out.println("gtRanking ");
		System.out.println(gtRanking);
		System.out.println(gtLabels);
		System.out.println("gtOrdering ");
		System.out.println(gtOrdering);
		System.out.println(getLabelsFromOrdering(gtOrdering));
